function [discretized] = discretize_FPKM_Mouse(fpkm,colnames,figflag)
%% modfieid from Discretize_Data
...
signal = log2(fpkm + 1); % modified: added a pseudovalue of 1 to avoid extreme negative values 
