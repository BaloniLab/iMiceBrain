function [model, A_final] = fastcormics_RNAseq_Mouse(model, data, rownames, dico, biomass_rxn, already_mapped_tag, consensus_proportion, epsilon, optional_settings)
...
% skipped by deactivating the function cuz we do not have any media
% constraints to add 
%composition
